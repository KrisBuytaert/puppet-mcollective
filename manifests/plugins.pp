class mcollective::plugins {
  ...
  file { "${p_base}/agent/service.rb":
    source => "${s_base}/agent/service/puppet-service.rb",
  }
  file { "${p_base}/agent/package.rb":
    source => "${s_base}/agent/package/puppet-package.rb",
  }
  file { "${p_base}/agent/nrpe.rb":
    source => "${s_base}/agent/nrpe/nrpe.rb",
  }
  file { "${p_base}/agent/puppetd.rb":
    source => "${s_base}/agent/puppetd/puppetd.rb",
  }
